...
class Configuartion:
    ...
    def get_data_transformation_config(self)->DataTransformationConfig:
        ...
        try:
            ...
            transformed_train_dir = os.path.join(data_transfromation_artifact_dir,
            ...
            transformed_test_dir = os.path.join(data_transfromation_artifact_dir,
                                                data_transfromation_config_info[DATA_TRANSFORMATION_DIR_NAME_KEY],
                                                data_transfromation_config_info[DATA_TRANSFORMATION_TEST_DIR_NAME_KEY])
            
            preprocessed_object_file_path = os.path.join(data_transfromation_artifact_dir,
